...
(()=>{const loader=document.createElement('div'); loader.id='flipLoader'; loader.innerHTML='<div class="loader-mark"><img src="assets/logo-flipco.png?v=4" alt="Flip&Co"></div><div class="loader-line"><i></i></div><div class="loader-meta"><span>SELECTED / CAGLIARI</span><span>LOADING EDIT</span></div>'; document.documentElement.classList.add('is-loading'); document.addEventListener('DOMContentLoaded',()=>{document.body.prepend(loader); requestAnimationFrame(()=>loader.classList.add('ready')); window.setTimeout(()=>{loader.classList.add('done'); document.documentElement.classList.remove('is-loading'); window.setTimeout(()=>loader.remove(),700)},820)});})();
